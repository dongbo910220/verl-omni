...
"${PYTHON_BIN}" -m verl_omni.trainer.main_omni \
    ...
    actor_rollout_ref.rollout.agent.default_agent_loop=qwen3_tts_single_turn \
    ...
    '+actor_rollout_ref.ref.fsdp_config.mixed_precision={param_dtype:fp32,reduce_dtype:fp32,buffer_dtype:fp32}' \
    ...
    +reward.custom_reward_function.reward_kwargs.timeout_s=120.0 \
    +reward.custom_reward_function.reward_kwargs.max_retries=2 \
    +reward.custom_reward_function.reward_kwargs.retry_backoff_s=0.5 \
